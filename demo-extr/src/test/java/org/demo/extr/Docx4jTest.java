...
public class Docx4jTest {
	 ...
	 * @throws Exception
	 */
	public static P newImage(WordprocessingMLPackage word, Part sourcePart, String imageFilePath) throws Exception {
		BinaryPartAbstractImage imagePart = BinaryPartAbstractImage.createImagePart(word, sourcePart,
	 ...
	 */
	public static void createHeaderReference(WordprocessingMLPackage word, Relationship relationship)
			throws InvalidFormatException {
	 ...
	 * @throws InvalidFormatException
	 */
	public static void createFooterReference(WordprocessingMLPackage word, Relationship relationship)
			throws InvalidFormatException {
		List<SectionWrapper> sections = word.getDocumentModel().getSections();
