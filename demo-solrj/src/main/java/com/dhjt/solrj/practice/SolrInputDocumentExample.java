package com.dhjt.solrj.practice;
...
import com.dhjt.solrj.utils.SolrJUtils;

public class SolrInputDocumentExample {
	...
	public static void main(String[] args) {
		// 通过浏览器查看结果
		//http://localhost:8983/solr/jcg/select?indent=on&q=name:%E6%94%B9%E9%9D%A9&wt=json
		addDocs();
		//delDocs();
	}
